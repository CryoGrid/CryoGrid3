function [] = CryoGrid3_function( runName, startDate, endDate, rainFrac, snowFrac, maxWater, maxSnow, snowDens, extFlux, fieldCapacity,evapDepth, ETversion, saturation )
...
%     PARA.soil.layer_properties=[    0.    saturation*0.80       0.10     0.10    2   0.80;...
%                                     0.9   0.65                  0.30     0.05    1   0.65;...
%                                     9.0   0.30                  0.70     0.00    1   0.30     ];
     PARA.soil.layer_properties=[ ...
         0.0           saturation*0.85  0.00    0.15    1   0.85;...
         0.2           0.90             0.05    0.05    1   0.90;...
         9.0           0.30             0.70    0.00    1   0.30     ] ;
