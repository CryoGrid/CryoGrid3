...
SETUP.startDate = datenum( 1979, 6, 10 );
SETUP.endDate = datenum( 1979, 12, 31 );

SETUP.saveDir = '/scratch1/jnitzbon/CryoGrid3/CryoGrid3_infiltration_xice_mpi/runs';
SETUP.saveDir = '/home/jnitzbon/CryoGrid/github/CryoGrid3_infiltration_xice_mpi/runs';
...
SETUP.d_xice_R=0.6;
SETUP.d_xice_T=0.3;
SETUP.extFlux=0;%-0.001;   % in [m/day] this refers to the flux on the landscape-scale and will be adjusted according to the areal fraction
SETUP.d_E=0.1;
SETUP.K=1e-5;
