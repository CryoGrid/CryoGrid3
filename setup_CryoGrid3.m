...
if SETUP.startFromRun
    ...
    polygonType = 'yedomaREV2';%'epigenetic'; %'syngenetic'
    ...
    SETUP.e_Reservoir = -10.0;%10.0;-0.2
    ...
    % topography
    SETUP.e_R = 0.0;%0.4;%0.2..0.4
    SETUP.e_T = 0.0;%SETUP.e_R-0.1;
    ...
    stratigraphyMap = containers.Map( {'CENTERsyngenetic', 'RIMsyngenetic', 'TROUGHsyngenetic', 'CENTERepigenetic', 'RIMepigenetic', 'TROUGHepigenetic',...
        'CENTERyedoma', 'RIMyedoma', 'TROUGHyedoma', 'CENTERyedomaREV2', 'RIMyedomaREV2', 'TROUGHyedomaREV2' }, ...
        { [ 0.00, OL1;...
            0.20, ML1;...
    ...
    SETUP.spinupFile = sprintf( 'SPINUP_REV2_194910-199912_rcp45_xice0_xE0_xH1_xW1_xS1_syngenetic_DarcyReservoirNoInflow_eRes-10.00_snowDens250_maxSnow0.40_DeltaXice0.00');%, SETUP.e_Reservoir );%polygonType
