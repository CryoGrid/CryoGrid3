...
spmd
    ...
    PARA.soil.layer_properties=[    0.0     0.85    0.00    0.15    1   0.85    ;...
    ...
    PARA.forcing.rain_fraction=1.0;   % scaling factor applied to the entire snowfall forcing data
    PARA.forcing.snow_fraction=1.0;   % scaling factor applied to the entire snowfall forcing data
