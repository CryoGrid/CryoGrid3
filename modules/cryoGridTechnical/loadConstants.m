function PARA = loadConstants( PARA )
    ...
    PARA.constants.k_o = 0.25;                                      % heat conductivity of organic material [ W/(mK) ] [	]
    % mineral
...
%tsvd IS  values from Andersland and Landanyi 1994 ("Introduction to frozen ground engineering")
    PARA.constants.rho_concrete = 2500;                                   % density of air [kg/m^3] @ 0°C, sea level
    PARA.constants.c_concrete = 1700. * PARA.constants.rho_concrete;      %c_a= 0.00125*10^6;%[J/m^3 K]   % volumetric heat capacity of dry air [J/(m^3 K)] @ 0°C, sea level, isobar
    PARA.constants.k_concrete = 0.67;                                   %ka=0.025; [Hillel(1982)]       % heat conductivity of air [ W/(mK)] @ 0 °C, sea level pressure     

    PARA.constants.rho_steel = 7500;                                   % density of air [kg/m^3] @ 0°C, sea level
    PARA.constants.c_steel = 500. * PARA.constants.rho_steel;      %c_a= 0.00125*10^6;%[J/m^3 K]   % volumetric heat capacity of dry air [J/(m^3 K)] @ 0°C, sea level, isobar
    PARA.constants.k_steel = 43.;                                   %ka=0.025; [Hillel(1982)]       % heat conductivity of air [ W/(mK)] @ 0 °C, sea level pressure     
end
