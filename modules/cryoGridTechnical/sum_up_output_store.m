function [TEMPORARY, OUT, BALANCE] = sum_up_output_store(t, T, wc, lwc, timestep, TEMPORARY, BALANCE, PARA, GRID, SEB, OUT, run_number)
    ...
    if  t==TEMPORARY.outputTime
        ...
        % mismatch
        OUT.WB.d_lackgin = [OUT.WB.d_lacking; BALANCE.water.d_lacking ];
