...
if PARA.modules.infiltration
    ...
    % unfrozen soil surface
        ...
        if Qe_pot>0
            ...
            fraction_T=getT_fraction(T(GRID.soil.cT_domain), wc, fieldCapacity);
            fraction_E=getE_fraction(T(GRID.soil.cT_domain), wc, fieldCapacity);
            %tsvd  fraction_T=getT_fraction(T(GRID.soil.cT_domain), wc, PARA.soil.fieldCapacity);
            %tsvd  fraction_E=getE_fraction(T(GRID.soil.cT_domain), wc, PARA.soil.fieldCapacity);
