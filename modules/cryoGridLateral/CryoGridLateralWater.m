    ...
    if precondition_waterExchange
        ...
        for j=1:numlabs
            if j~=labindex
                ...
                water_fluxes = calculateLateralWaterDarcyFluxes( T, PACKAGE_waterExchange_j, GRID, PARA, j, water_fluxes);  % matrix containing all fluxes in [m] scaled to row index
            end
        end
