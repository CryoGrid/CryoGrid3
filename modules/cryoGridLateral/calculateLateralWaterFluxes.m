...
%tsvd IS if PARA.ensemble.hydraulic_contact_length(index,j)>0
if PARA.ensemble.hydraulic_contact_length>0
...
%tsvd IS            section=contact_height .* PARA.ensemble.hydraulic_contact_length(j,index);
